...
Some observations can be made using these graphs.  Peak steps occurs in the morning during weekdays, and late afternoon on weekends.  Activity through weekend days appears more even, with noticably more activity over the middle of the day as compared to weekdays.  Overall, weekday mornings are with the most steps occured.
